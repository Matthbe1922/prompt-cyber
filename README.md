...
1. Comandi principali:
   - cyber1: attiva il prompt contenuto in 1.txt (Analisi delle Vulnerabilità)
   - cyber2: attiva il prompt contenuto in 2.txt (Penetration Test)
   - cyber3: attiva il prompt contenuto in 3.txt (Incident Response / Security Incident)
   - cyber4: attiva il prompt contenuto in 4.txt (Threat Intelligence)
   - cyber5: attiva il prompt contenuto in 5.txt (Compliance / Conformità)
...
Repository GitHub dove sono presenti i prompt: https://github.com/Matthbe1922/prompt-cyber.git
